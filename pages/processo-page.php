...
<?php
  ...
  if (isset($_GET['id'])) {
      $id = $_GET['id'];  
      $sql_code = "SELECT `titulo`,`conteudo` FROM processos WHERE `processos`.`id` = $id";
      $sql_query = $mysqli->query($sql_code) or die("Falha na execução da requisição");
      if (isset($sql_query)) {
        $processos = $sql_query->fetch_assoc();
?>
          <article class="info-col1">
            <div class="title-info" style="padding-bottom:16px">
              <h1><?php echo $processos['titulo'] ?></h1>
            </div>
            <br><br>
            <?php echo $processos['conteudo'] ?>
...
?>
          ...
          <aside class="info-col2">
            ...
            <p><a style="text-decoration: none; color: black;" href="documentos-importantes.php#normas-resolucoes"><i class="fa-regular fa-folder-open"></i> Normas e Resoluções</a></p>
            <p><a style="text-decoration: none; color: black;" href="documentos-importantes.php#oferta-disciplina"><i class="fa-regular fa-folder-open"></i> Oferta de Disciplinas</a></p>
            <p><a style="text-decoration: none; color: black;" href="documentos-importantes.php#portaria-oficios"><i class="fa-regular fa-folder-open"></i> Portarias e Ofícios</a></p>
            <p><a style="text-decoration: none; color: black;" href="documentos-importantes.php#processo-seletivo"><i class="fa-regular fa-folder-open"></i> Processo seletivo</a></p>
            <a class="btn btn-sm btn-outline-primary ver-mais" href="documentos-importantes.php">Ver mais...</a>
          </aside>
        </section>
